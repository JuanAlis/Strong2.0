...
export const EXERCISES: Exercise[] = [
  ...
  { id: "dp_bb", name: "Press declinado (Barra)", group: "Pecho", equipment: "Barra", primary: ["chest"], secondary: ["triceps"] },
  ...
  { id: "pullover", name: "Pullover (Mancuerna)", group: "Espalda", equipment: "Mancuerna", primary: ["lats"], secondary: ["chest"] },
  { id: "pullover_bb", name: "Pullover (Barra)", group: "Espalda", equipment: "Barra", primary: ["lats"], secondary: ["chest"] },
  { id: "back_ext_rc", name: "Extensión de espalda (silla romana)", group: "Espalda", equipment: "Peso corporal", primary: ["lowerBack"], secondary: ["glutes", "hamstrings"] },
  ...
  { id: "fr_db", name: "Elevaciones frontales (Mancuerna)", group: "Hombros", equipment: "Mancuerna", primary: ["frontDelt"], secondary: [] },
  { id: "fr_bb", name: "Elevaciones frontales (Barra)", group: "Hombros", equipment: "Barra", primary: ["frontDelt"], secondary: [] },
  ...
  { id: "upright", name: "Remo al mentón (Barra)", group: "Hombros", equipment: "Barra", primary: ["sideDelt", "traps"], secondary: [] },
  { id: "upright_db", name: "Remo al mentón (Mancuerna)", group: "Hombros", equipment: "Mancuerna", primary: ["sideDelt", "traps"], secondary: [] },
  ...
  { id: "pre_bb", name: "Curl predicador (Barra)", group: "Bíceps", equipment: "Barra", primary: ["biceps"], secondary: [] },
  { id: "pre_db", name: "Curl predicador (Mancuerna)", group: "Bíceps", equipment: "Mancuerna", primary: ["biceps"], secondary: [] },
  { id: "pre_m", name: "Curl predicador (Máquina)", group: "Bíceps", equipment: "Máquina", primary: ["biceps"], secondary: [] },
  ...
  // TRÍCEPS
  { id: "skull", name: "Skullcrusher (Barra)", group: "Tríceps", equipment: "Barra", primary: ["triceps"], secondary: [] },
  { id: "skull_db", name: "Skullcrusher (Mancuerna)", group: "Tríceps", equipment: "Mancuerna", primary: ["triceps"], secondary: [] },
  ...
  { id: "lung_bb", name: "Zancadas (Barra)", group: "Piernas", equipment: "Barra", primary: ["quads", "glutes"], secondary: ["hamstrings"] },
  { id: "bsq", name: "Sentadilla búlgara (Mancuerna)", group: "Piernas", equipment: "Mancuerna", primary: ["quads", "glutes"], secondary: ["hamstrings"] },
  { id: "bsq_bb", name: "Sentadilla búlgara (Barra)", group: "Piernas", equipment: "Barra", primary: ["quads", "glutes"], secondary: ["hamstrings"] },
  ...
  { id: "step_up", name: "Subidas al cajón (Mancuerna)", group: "Piernas", equipment: "Mancuerna", primary: ["quads", "glutes"], secondary: [] },
  { id: "step_up_bb", name: "Subidas al cajón (Barra)", group: "Piernas", equipment: "Barra", primary: ["quads", "glutes"], secondary: [] },
  { id: "rdl_leg", name: "Peso muerto rumano", group: "Piernas", equipment: "Barra", primary: ["hamstrings", "glutes"], secondary: ["lowerBack"] },
  ...
  { id: "hip", name: "Hip Thrust (Barra)", group: "Piernas", equipment: "Barra", primary: ["glutes"], secondary: ["hamstrings"] },
  { id: "hip_db", name: "Hip Thrust (Mancuerna)", group: "Piernas", equipment: "Mancuerna", primary: ["glutes"], secondary: ["hamstrings"] },
  ...
  { id: "plank", name: "Plancha", group: "Abdomen", equipment: "Peso corporal", primary: ["abs"], secondary: ["obliques", "lowerBack"] },
  { id: "plank_side", name: "Plancha de oblicuos", group: "Abdomen", equipment: "Peso corporal", primary: ["obliques"], secondary: ["abs"] },
];
